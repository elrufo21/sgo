      ...
      <div className="max-w-5xl mx-auto">
        <div className="bg-white rounded-2xl shadow-xl overflow-visible relative">
          ...
          <HookForm methods={formMethods} onSubmit={onSubmit}>
            <div className="sticky top-0 z-30 bg-[#B23636] text-white px-4 py-3 rounded-t-2xl flex items-center justify-between shadow-lg shadow-black/10 sm:top-2">
            ...
            <div className="p-6 pb-24 sm:p-8">
            ...
            <div className="fixed inset-x-0 bottom-0 z-40 border-t border-black/10 bg-[#B23636] px-4 py-2 pb-[calc(0.5rem+env(safe-area-inset-bottom))] shadow-[0_-6px_20px_rgba(0,0,0,0.2)] sm:hidden">
