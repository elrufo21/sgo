...
export default function CashFlowForm({
  ...
  return (
    ...
    >
      <div className="sticky top-20 sm:top-2 z-30 bg-[#B23636] text-white px-2 sm:px-4 py-2 flex items-center justify-between flex-shrink-0 shadow-lg shadow-black/10">
